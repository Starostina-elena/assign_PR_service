...
##### UPD 18.11.25: во имя соответствия "проект запускается командой docker-compose up без дополнительных действий" .env добавлен в репозиторий, будет удален позднее 
```make up```
